...
from functions.RooUnfold import RooUnfold_unfolder, RooUnfold_plot, RooUnfold_plot_response
...
def main():
    ...
    for distr in distributions:
        ...
        unfolded_SA = QUnfold_unfolder_and_plot("SA", response, meas, truth, distr, bins, min_bin, max_bin)
